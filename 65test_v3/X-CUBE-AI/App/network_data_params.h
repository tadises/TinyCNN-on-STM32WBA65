...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 1908, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (1908)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (1908)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 15448, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (15448)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (15448)

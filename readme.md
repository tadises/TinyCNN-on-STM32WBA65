...
![4种对比](D:\NTU\Dissertation\组会\功率测试\2种待机电流.png)



![4种对比](D:\NTU\Dissertation\组会\功率测试\4种对比.png)The proposed model was successfully deployed on the STM32WBA65 microcontroller using the STM32 X-CUBE-AI toolchain for on-device inference. Power consumption measurements were conducted under multiple operating configurations to evaluate the energy efficiency of the system during a one-minute duty cycle consisting of startup, inference, and low-power standby or stop modes.
